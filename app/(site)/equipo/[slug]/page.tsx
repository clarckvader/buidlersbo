...
import { getTeamSlugs, getTeam } from '@/lib/content'
      ...
      <div style={{ maxWidth: 720, margin: '0 auto' }}>
        ...
        <div className="card" style={{ padding: 24, marginBottom: 16 }}>
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 16 }}>
            <div style={{ flex: '1 0 130px' }}><div className="mono" style={{ fontSize: 11, color: 'var(--ink-faint)' }}>LEAD</div><div>{team.lead}</div></div>
            <div style={{ flex: '1 0 130px' }}><div className="mono" style={{ fontSize: 11, color: 'var(--ink-faint)' }}>MIEMBROS</div><div>{team.members}</div></div>
